...
map.getView().fit([11972057.077336, -776097.430929, 11991212.910669, -766243.171670], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Bandung Architectural Map 1900-1942</h2>';
        return titleElement;
    })(),
    ...
    element: (() => {
        ...
        if (35 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = 'Test: Building and Urban Dev on web';
            }
